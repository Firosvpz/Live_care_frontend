...
export const userRegister = async(name: string, email: string, password: string,phone_number: string,gender:string) => {
    try {
        const response = await Api.post(user_endpoints.register, {name, email, password, phone_number,gender})
