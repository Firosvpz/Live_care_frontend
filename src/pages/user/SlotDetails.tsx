                                        ...
                                        >
                                            <div className="flex justify-between items-center mb-4">
                                                <h5 className="text-xl font-semibold text-gray-800">
                                                    {new Date(slot.slots.date).toLocaleDateString("en-US", {
                                                        day: "numeric",
                                                        month: "short",
                                                    })}
                                                </h5>
                                                <span
                                                    className={`px-2 py-1 rounded-full text-xs font-semibold ${slot.slots.schedule.status === "open"
                            ...
                            {serviceProvider && (
                                <div className="text-center rounded-xl shadow-lg p-8 bg-indigo-50">
                                    ...
                                    <div className="space-y-3 text-left">
                                        ...
                                        <p className="text-gray-700">
                                            <span className="font-semibold text-indigo-600">Service:</span>{" "}
