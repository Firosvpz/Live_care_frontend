...
export default function UserLanding() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const [categoriesData, providersData, { data: userData }] =
          await Promise.all([
            fetchCategories(),
            fetchApprovedAndUnblockedProviders(),
            getProfileDetails(),
                ...
                >
                  <div className="p-8">
                    ...
                    <p className="text-gray-600 mb-6">
                      Discover exceptional {category.toLowerCase()} services
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-600 mb-12 max-w-2xl mx-auto">
              ...
              service providers via video calls and chat. Enjoy personalized
              care and support from the comfort of your home.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-600">
                  Face-to-face consultations from anywhere
                </p>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
              ...
              >
                ...
                <p className="text-gray-600">
                  Instant messaging for quick queries and support
                </p>
              </motion.div>
            </div>
          </div>
