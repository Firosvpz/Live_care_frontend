                ...
                <Form noValidate onSubmit={handleSubmit(onSubmit)}>
                    <Row>
                        ...
                        <Col md={6} className="mb-3">
                            <Form.Group controlId="validationCustomDob" className="register-form-input w-100">
                                <Form.Control
                                    type="date"
                                    className="bg-dark text-white"
                                    {...register("dob", {
                                        required: "DOB is required",
                                        validate: value => new Date(value) < new Date('1990-01-01') || "Must be before 1990"
                                    })}
                        ...
                        {/* Address */}
                        <Col md={6} className="mb-3">
                            <Form.Group controlId="validationCustomAddress" className="register-form-input bg-dark w-100">
                                <Form.Control
                                    type="text"
                                ...
                                />
                                <Form.Control.Feedback type="invalid">{errors.user_address?.message}</Form.Control.Feedback>
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={6} className="mb-3">
                            <Form.Group controlId="validationCustomMedicalHistory" className="register-form-input w-100">
                                <Form.Control
                                    as="select"
                                ...
                                <Form.Control.Feedback type="invalid">{errors.medical_history?.message}</Form.Control.Feedback>
                            </Form.Group>
                        </Col>

                        {/* Blood Group Dropdown */}
                        <Col md={6} className="mb-3">
                            <Form.Group controlId="validationCustomBloodType" className="register-form-input w-100">
                                <Form.Control
                                    as="select"
                                    className="bg-dark text-white" // Dropdown styling
                                    {...register("blood_type", {
                                ...
                                <Form.Control.Feedback type="invalid">{errors.blood_type?.message}</Form.Control.Feedback>
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={6} className="mb-3">
                            <Form.Group controlId="validationCustomProfilePic" className="register-form-input w-100">
                                ...
                                />
                                <Form.Control.Feedback type="invalid">{errors.profile_picture?.message}</Form.Control.Feedback>
                            </Form.Group>
                        </Col>
