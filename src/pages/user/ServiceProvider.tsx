      ...
      >
        <div className="max-w-7xl mx-auto ">
          <div className=" bg-opacity-90 outset bg-black/80 rounded-lg shadow-xl p-8 mb-8">
            <div className="text-4xl font-bold text-gray-100 mb-6 text-center">
              Service Providers
            </div>
          ...
          {filteredProviders.length === 0 && (
            <p className="text-center text-white text-xl mt-6 bg-gray-800 bg-opacity-75 p-4 rounded-lg">
