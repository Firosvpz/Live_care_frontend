...
const Home: React.FC = () => {
  ...
  return (
   ...
   {/* Services Section */}
   <section className="relative h-screen flex items-center justify-center bg-cover bg-center"  style={{ backgroundImage: `url('/images/register.jpg')` }}>
  <div className="absolute inset-0 bg-black/80 z-0"></div> {/* Overlay for depth */}
  <div className="container text-center relative z-10">
    ...
    <Carousel indicators={false} controls={true} interval={2000}>
      {loading ? (
          ...
          <Carousel.Item key={index}>
            <div className="row justify-content-center p-5">
              {providerGroup.map((provider) => (
                <div key={provider._id} className="col-lg-3 col-md-6 mb-4 ms-5">
        ...
        <Carousel.Item>
          <div className="text-center text-gray-500">No service providers found.</div>
        </Carousel.Item>
      )}
    </Carousel>
  </div>
