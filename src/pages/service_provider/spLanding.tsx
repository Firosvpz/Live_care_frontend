...
const ServiceProviderLanding: React.FC = () => {
  ...
  return (
    <>
      <SpHeader />
      <div className="relative bg-cover bg-center h-screen" style={{ backgroundImage: 'url("/public/images/spHomee.jpg")' }}>
        <div className="absolute inset-0 bg-black opacity-60"></div>
        <div className="relative flex flex-col items-center justify-center h-full w-full text-white text-center p-8">
          <h1 className="text-5xl md:text-7xl font-bold mb-4 slide-in">Welcome {profileData?.name}</h1>
          <p className="mt-2 text-xl md:text-2xl fade-in">Empowering you in senior care excellence</p>
        </div>
      </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {["Senior Consultation", "Home Health Monitoring", "Tailored Care Plans"].map((service) => (
              <div
                key={service}
              ...
              >
                ...
                <p className="text-lg">Exceptional {service.toLowerCase()} for your clients’ well-being.</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto text-center">
          ...
          <div className="bg-gray-200 rounded-lg p-8 shadow-lg mx-auto max-w-3xl">
            <h3 className="font-semibold text-xl mb-4">How can I enhance my service delivery?</h3>
            <p className="text-gray-700">We offer continuous training and resources to help you excel in your caregiving role.</p>

            <h3 className="font-semibold text-xl mt-6 mb-4">What support can I access?</h3>
            <p className="text-gray-700">Our dedicated team is always here to assist you with any inquiries or support you need.</p>
          </div>
        </div>
      </section>
