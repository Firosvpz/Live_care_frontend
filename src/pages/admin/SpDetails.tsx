...
import { approveServiceProvider, getServiceProviderDetails } from "../../api/admin_api";
            ...
            <div className="flex min-h-screen">
                ...
                <main className="flex-grow p-6 bg-gradient-to-br from-teal-100 via-white to-teal-50">
                    {loading ? (
                        ...
                        >
                             <button className=" inline-flex text-sm font-medium text-gray-1000  hover:text-white" onClick={() => window.history.back()}>
                        ...
                        <p className="text-center text-white">Service Provider details not found.</p>
                    )}
                    <ApprovalModal open={openModal} onClose={() => setOpenModal(false)} onApprove={handleApproval} />
                </main>
            </div>
            <Footer />
        </>
        ...
        {serviceProvider.hasCompletedDetails ? (
            <div className="text-center">
                ...
                <div className="mt-8 space-y-4">
                    <div className="flex justify-center space-x-4 mb-5"> {/* Flex container for buttons */}
                        <DocumentButton 
                            icon={<FiFileText />} 
